        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <form action="fr_login.php" method="post" class="amarante mb-5 mt-2 p-md-5 p-4" id="createLandlordForm">
                    <marquee behavior="" direction="left" class="mb-3 text-danger aclonica">Veuillez saisir vos données de connection !</marquee>
                    ...
                    <div class="form-group mb-3">
                        <a href="forgot_password.php" class="float-left">Mot de Passe oublié ?</a>
                        <a href="signup.php" class="float-right">S'inscrire ?</a>
                    </div>
                </form>
            </div>
        </div>
